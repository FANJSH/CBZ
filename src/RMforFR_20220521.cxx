...
RMforFR_LowOrderModel::RMforFR_LowOrderModel(int n1, int n2, int n3)
{
        input_data = n1;
        output_data = n2;
        num_vib = n3;
...
vector<double> RMforFR_LowOrderModel::GetRegressionResult(vector<double> &xinp)
{
        ...
        vector<double> yout=postp.PostSLV(vb);
...
void RMforFR_Showresult::resultout(vector<double> result)
{
        ...
        if(fin.fail()){
            ...
            cout<<"# File named ["<<fin<<"] cannot be found.\n";
            exit(0);
        };
...
vector<double> RMforFR_allcalculation::RegressionModelEstimation(bool print_option)
{
        ...
        RMforFR_LowOrderModel WR(input_data, output_data, num_vib); // The number of calculation
        ...
        RMforFR_Showresult TRU(4, output_data);
        TRU.resultout(coolb);
	...
	if(print_option){
        ...
        youtc = CORE.GetRegressionResult(coola);
        ...
        youtw = WASTE.GetRegressionResult(coola);
