...
class MulticellBurner:public GeneralBurner{
 protected:
  ...
  void ForwardCalculationNEL2020(Burnup &bu, int med_target);
  void ForwardCalculationNEL2020_3x3(Burnup &bu, int med_target,int adts_step);  
  void ForwardCalculationNEL2020Sasuga(Burnup &bu, int med_target);
  void ForwardCalculationNEL2020SasugaFinal(Burnup &bu, int med_target);    
  void SensitivityCalculationPC(Burnup &bu, int med_normalize, int num_med, int *med_target, int num, int *nucid,string filename);
  void ForwardCalculationAOWPCtoADTS(Burnup &bu, int med_target, int ngrp, int *bgrp, bool adjoint=false);
 ...
 public:
  ...
  void PutIGI_NEL2020_3x3(IrregularGeometryInformation &igia,IrregularGeometryInformation &igib,bool reflective=false);  
  void PutIGI_NEL2020(IrregularGeometryInformation &igi_33);  // NEL2020
  ...
  void CalculationADTS_toOWPC(Burnup &bu, int med_target, int ngrp, int *bgrp);   // by Miyazawa-kun in 2022/1/26
  void Calculation_newPC(Burnup &bu, int med_target, int ngrp, int *bgrp); // by Miyazawa-kun in 2022/2/8  
  void CalculationNEL2020(Burnup &bu, int med_target);
  void CalculationNEL2020_3x3(Burnup &bu, int med_target, int adts_step);  
  ...
  real EigenvalueCalculationSPH(Burnup &bu);  
  ...
  void SensitivityCalculationDirect(Burnup &bu, int med_normalize, int matid, int mtid, int target_num, int *nucid, string filename,bool sigt_preserve=false); // hard-coded for 3x3 problem in May, 2022
  ...
  vector<real> ShowVolumeAveragedNumberDensity(int prt_nuc, string *prt_nuc_nam, int num_med, int *med_target);
  void ShowBurnupHistory();
  void ShowFuelNeutronFlux(int st, bool excel=false);
  void ShowCalculationCondition();
