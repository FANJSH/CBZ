    ...
    */
	...
	for(int i=0;i<mednum_fuel;i++){
          ...
          for(int k=0;k<nucn;k++){
            ...
            bu.PutNuclideData(k,id,den,xsf_1g[st][i][k],xsc_1g[st][i][k],xsn2n_1g[st][i][k]);
          };
	...
	if(owpc_corr){
	  ...
	  if(st>0){
	    ...
	    */	    
	    ...
	    real rc_157=(aa_7*(X_5-b_5)*(X_5-c_5)/(a_5-b_5)/(a_5-c_5))+(bb_7*(X_5-a_5)*(X_5-c_5)/(b_5-a_5)/(b_5-c_5))+(cc_7*(X_5-a_5)*(X_5-b_5)/(c_5-a_5)/(c_5-b_5));//quadratic of 155
	    //real rc_157=(aa_7*(X_7-b_7)*(X_7-c_7)/(a_7-b_7)/(a_7-c_7))+(bb_7*(X_7-a_7)*(X_7-c_7)/(b_7-a_7)/(b_7-c_7))+(cc_7*(X_7-a_7)*(X_7-b_7)/(c_7-a_7)/(c_7-b_7));//quadratic of each
	    ...
	    real rc_r_157=aa_7*(X_5-b_5)*(X_5-c_5)/(a_5-b_5)/(a_5-c_5)+bb_7*(X_5-a_5)*(X_5-c_5)/(b_5-a_5)/(b_5-c_5)+cc_7*(X_5-a_5)*(X_5-b_5)/(c_5-a_5)/(c_5-b_5);//quadratic of 155
	    //real rc_r_157=aa_7*(X_7-b_7)*(X_7-c_7)/(a_7-b_7)/(a_7-c_7)+bb_7*(X_7-a_7)*(X_7-c_7)/(b_7-a_7)/(b_7-c_7)+cc_7*(X_7-a_7)*(X_7-b_7)/(c_7-a_7)/(c_7-b_7); //quadratic of each
