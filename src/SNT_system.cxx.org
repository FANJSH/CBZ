...
real SNTSystem::CalFluxXY(int g,int oiter,real epsif)
{
  ...
  for(int it=0;it<itmax;it++){
    ...
    for(int is=0;is<sn;is++){
      ...
      bool xnref = false;
      if((mu<0.&&BC[0]==1)||(mu>0.&&BC[1]==1))xnref=true;
      bool ynref = false;
      if((et<0.&&BC[2]==1)||(et>0.&&BC[3]==1))ynref=true;
      bool xpref = false;
      if((mu>0.&&BC[0]==1)||(mu<0.&&BC[1]==1))xpref=true;
      int iss=is;
