...
void GeneralBurner::SetLibrary(string cbglibdir,string lib,int fp_num,string *fp_nuc)
{
  ...
  string filename_hm[]={
    ...
    "Cm246","Cm247",
    /*
    // (replaced in 2021/8/9)
    "U234.U8R","U235.U8R","U236.U8R","U237","U238.mixR",
    "Np237","Np239","Pu238.U8R","Pu239.mixR","Pu240.mixR",
    "Pu241.mixR","Pu242.mixRR","Am241.mixR","Am242","Am242m",    
    "Am243.U8R","Cm242","Cm243","Cm244.U8R","Cm245.U8R",
    "Cm246",    
    */
  };
  string filename_str[]={
  ...
  xslib.ReadFile(22,libdir,filename_hm);  
  ...
  xslib.GetLibData(922350).GetThScat().ReadFile(libth,"U235");
  xslib.GetLibData(922380).GetThScat().ReadFile(libth,"U238");
  xslib.GetLibData(942390).GetThScat().ReadFile(libth,"Pu239");
  xslib.GetLibData(942400).GetThScat().ReadFile(libth,"Pu240");
  xslib.GetLibData(942410).GetThScat().ReadFile(libth,"Pu241");
  xslib.GetLibData(942420).GetThScat().ReadFile(libth,"Pu242");          
  ...
  /*
  for(int i=0;i<107;i++){
    real e0=xslib.GetEnband().get_dat(i);
    if(e0<100.)xslib.GetLibData(922380).PutBellFactor(i,1.2);
    //cout<<xslib.GetEnband().get_dat(i)<<" ";    
    //cout<<xslib.GetLibData(922380).GetBellFactor(i)<<"\n";
  };
  //exit(0);
  */
  
  //xslib.GetLibData(430990).PutBellFactorAllGroup(1.2);
  //xslib.GetLibData(430990).PutBellFactor(57, 1.5);  
  //xslib.GetLibData(621520).PutBellFactorAllGroup(1.2);
  //xslib.GetLibData(621520).PutBellFactor(56, 1.0);

  //cout<<xslib.GetLibData(942420).GetBellFactor(60)<<"\n"; exit(0);
  //xslib.GetLibData(942420).PutBellFactor(60, 1.5);    
  ...
  int mix_nd_num=5+2+3+1;
  string fname[]={

    "Cm244.P9","U238.P0","Pu239.U8","Pu239.P1","Pu239.P0",
    "Cm244.U5","Pu240.P9",
    "Cm244.Sm2","Sm152.C4","Tc099.U5",
    "Pu242.P8",

    /*
    "Cm244.P9R","U238.P0R","Pu239.U8R","Pu239.P1R","Pu239.P0R",
    "Cm244.U5R","Pu240.P9R",
    "Cm244.Sm2R","Sm152.C4R","Tc099.U5R",
    "Pu242.P8RR",
    */
    //"Pu242.P9RR","Pu242.P0RR","Pu242.P1RR","Pu242.U5RR",
    // "Tc099.A1R",
    // "Sm152.P9R","Sm152.S1R",
    //"Pu242.P8R"
  };    
  int idtmp[]={10,1,2,3,4, 5,6, 9,11,12, 13};
  xslib2.ReadFile(mix_nd_num,libdir,fname,idtmp);

  for(int i=0;i<mix_nd_num;i++){
    int grp2=xslib2.GetLibData(idtmp[i]).GetGroup();
    if(grp2!=107){
      cout<<"# Error in GeneralBurner::SetLibrary.\n";
      cout<<"# The number of energy groups of the mixed library is different from that of the original library.\n";
      cout<<"#\n";
      cout<<"#    The number of energy groups of the original Lib. : 107\n";
      cout<<"#    The number of energy groups of the mixed Lib.    : "<<grp2<<"\n";
      exit(0);
    };
  };

  // (Cm-244)
  xslib.GetLibData(962440).GetFtable().AddData(xslib2.GetLibData(10).GetFtable(),56); // w Pu-239
  xslib.GetLibData(962440).GetFtable().AddData(xslib2.GetLibData(5).GetFtable(),56);  // w U-235
  xslib.GetLibData(962440).GetFtable().AddData(xslib2.GetLibData(9).GetFtable(),56);  // w Sm-152  
  ...
  // (Pu-242)
  xslib.GetLibData(942420).GetFtable().AddData(xslib2.GetLibData(13).GetFtable(),60);  // w Pu-238
  //xslib.GetLibData(942420).GetFtable().AddData(xslib2.GetLibData(14).GetFtable(),60);  // w Pu-239
  //xslib.GetLibData(942420).GetFtable().AddData(xslib2.GetLibData(15).GetFtable(),60);  // w Pu-239
  //xslib.GetLibData(942420).GetFtable().AddData(xslib2.GetLibData(16).GetFtable(),60);  // w Pu-239
  //xslib.GetLibData(942420).GetFtable().AddData(xslib2.GetLibData(17).GetFtable(),60);  // w Pu-239  

  // (Sm-152) The following RI treatment has very small effects on Sm-152 ND
  /*
  xslib.GetLibData(621520).GetFtable().AddData(xslib2.GetLibData(11).GetFtable(),56); // w Cm-244
  xslib.GetLibData(621520).GetFtable().AddData(xslib2.GetLibData(14).GetFtable(),56); // w Pu-239
  xslib.GetLibData(621520).GetFtable().AddData(xslib2.GetLibData(15).GetFtable(),56); // w Sm-151
  */
  
  // (Tc-99)
  xslib.GetLibData(430990).GetFtable().AddData(xslib2.GetLibData(12).GetFtable(),57); // w U-235
  //xslib.GetLibData(430990).GetFtable().AddData(xslib2.GetLibData(13).GetFtable(),57); // w Am-241
  /*
...
void GeneralBurner::SetLibrary(string cbglibdir,string lib)
{
  ...
  string filename_fp[]={
    ...
    //"Tc099.U8R","Ru100","Ru101","Ru102","Ru103", // !
    ...
    "Xe136","Cs133.U8","Cs134","Cs135","Cs136", // !
    ...
    //"Sm148","Sm149","Sm150.T2","Sm151.U8R","Sm152.U8R", // !
    "Sm148","Sm149","Sm150.T2","Sm151.U8","Sm152.U8", // !    
    "Sm153","Sm154","Eu151","Eu152","Eu153.T2", // !
    "Eu154","Eu155.T2","Eu156","Eu157","Gd152",
  ...
  for(int g=0;g<107;g++){
    ...
    xslib.GetLibData(mat).GetXSData().GetData1d(sigc).add_data(g,org*0.001);    
  };
  */
...
void GeneralBurner::SetLibraryAll(string cbglibdir,string lib)
{
  ...
  string filename_fp[]={
    ...
    "Cs133.U8","Cs134","Cs135","Cs136","Cs137", // !
    ...
    "Sm144","Sm147","Sm148","Sm149","Sm150.T2","Sm151.U8R","Sm152.U8R","Sm153","Sm154", // !
    "Eu151","Eu152","Eu153.T2","Eu154","Eu155.T2","Eu156","Eu157", // !
...
void GeneralBurner::SetLibrary_172g(string cbglibdir,string lib)
{
  ...
  string libdir=cbglibdir;
  if(lib=="jendl-4.0"){
    libdir=libdir+"CBGLIB/j4.172g.iwt4/";
  }else{
    cout<<"# Error in GeneralBurner::SetLibrary.\n";
    cout<<"# Library "<<lib<<" does not exist.\n";
    exit(0);
  ...
  string filename_hm[]={
    ...
    "U234.U8","U235.U8","U236.U8","U237","U238.mix",
    "Np237","Np239","Pu238.U8","Pu239.mix","Pu240.mix",
    "Pu241.mix","Pu242.mix","Am241.U8","Am242","Am242m",
    "Am243.U8","Cm242","Cm243","Cm244.U8","Cm245.U8",
    "Cm246","Cm247",
  };
  string filename_str[]={
  ...
  */
  ...
  string filename_fp[]={
    ...
    //"Sm144","Sm147","Sm148","Sm149","Sm150.U8","Sm151.U8","Sm152.U8","Sm153","Sm154",
    "Eu151","Eu152","Eu153.T2","Eu154.T2","Eu155.T2","Eu156","Eu157",
  ...
  // (Bell factor-optimization)
  string belldir=libdir+"Bell/";
  xslib.ReadBellFactor(belldir,"U235",922350);
  xslib.ReadBellFactor(belldir,"U238",922380);
  xslib.ReadBellFactor(belldir,"Pu239",942390);
  xslib.ReadBellFactor(belldir,"Pu240",942400);
  xslib.ReadBellFactor(belldir,"Pu241",942410);
  xslib.ReadBellFactor(belldir,"Pu242",942420);
  ...
  for(int i=0;i<172;i++){
    ...
    //cout<<xslib.GetEnband().get_dat(i)<<" ";
    cout<<i<<" "<<e0<<" ";
    cout<<xslib.GetLibData(942390).GetBellFactor(i)<<" ";
    cout<<xslib.GetLibData(942400).GetBellFactor(i)<<" ";
    cout<<xslib.GetLibData(942410).GetBellFactor(i)<<" ";
    cout<<xslib.GetLibData(942420).GetBellFactor(i)<<" ";
    cout<<"\n";
  };
  exit(0);
  */
  ...
  string fname[]={"U238.P0","Pu239.P0","Cm244.P9","Cm244.Sm2","Sm152.C4"};
  int idtmp[]={0,1,2,3,4};
  xslib2.ReadFile(5,libdir,fname,idtmp);  

  xslib.GetLibData(922380).GetFtable().AddData(xslib2.GetLibData(0).GetFtable(),68); // w Pu-240
  xslib.GetLibData(942390).GetFtable().AddData(xslib2.GetLibData(1).GetFtable(),79); // w Pu-240

  xslib.GetLibData(962440).GetFtable().AddData(xslib2.GetLibData(2).GetFtable(),86); // w Pu-239
  xslib.GetLibData(962440).GetFtable().AddData(xslib2.GetLibData(3).GetFtable(),86); // w Sm-152

  xslib.GetLibData(621520).GetFtable().AddData(xslib2.GetLibData(4).GetFtable(),86); // w Cm-244
};

void GeneralBurner::SetLibrary_361g(string cbglibdir,string lib)
{
  up_scattering=true;
  PutGroup(361);
  ...
  string libdir=cbglibdir;
  if(lib=="jendl-4.0"){
    libdir=libdir+"CBGLIB/j4.361g.iwt4/";
    //libdir=libdir+"CBGLIB/j4.361g.iwt4_shielding/";
  }else if(lib=="jendl-5"){
    libdir=libdir+"CBGLIB/j5.361g.iwt4/";    
  }else if(lib=="endf-8"){
    libdir=libdir+"CBGLIB/e80.361g.iwt4/";    
  }else if(lib=="endf-7.1"){
    libdir=libdir+"CBGLIB/e71.361g.iwt4/";    
  }else if(lib=="jeff-3.2"){
    libdir=libdir+"CBGLIB/jf32.361g.iwt4/";    
  }else if(lib=="jeff-3.3"){
    libdir=libdir+"CBGLIB/jf33.361g.iwt4/";    
  }else{
    cout<<"# Error in GeneralBurner::SetLibrary.\n";
    cout<<"# Library "<<lib<<" does not exist.\n";
    exit(0);
  ...
  cout<<"#############################################################################\n";
  cout<<"#\n";
  cout<<"# Important notice when using the 361-group library\n";
  cout<<"#\n";
  cout<<"# When Fukushima-2 Unit-2 assembly burnup calculation is conducted,\n";
  cout<<"# phenomena of the inner iteration divergence is observed.\n";
  cout<<"# In this case, negative self-scattering due to the transport approximation\n";
  cout<<"# in group 180 (179 in CBZ) (21.336 - 21.2296 eV) causes this divergence.\n";
  cout<<"# When the self-scattering is reset to zero only in this group,\n";
  cout<<"# converged solution can be obtained.\n";
  cout<<"# This modification is made on [Medium::TrasnportApproximation].\n";
  cout<<"#############################################################################\n";  
  ...
  xslib.ReadFile(nuc_num_hm,libdir,filename_hm);
  xslib.ReadFile(fp_num,libdir,filename_fp);
  xslib.ReadFile(12,libdir,filename_str);
  ...
  libth.append("Thermal/");
  xslib.GetLibData(10010).GetThScat().ReadFile(libth,"H.H2O");
  xslib.GetLibData(80160).GetThScat().ReadFile(libth,"O016");
  xslib.GetLibData(922350).GetThScat().ReadFile(libth,"U235");
  xslib.GetLibData(922380).GetThScat().ReadFile(libth,"U238");
...
void GeneralBurner::SetLibraryFP103(string cbglibdir,string lib)
{
  ...
  string filename_fp[]={
    ...
    "Xe136","La139","La140","Cs133.U8","Cs134",
...
{
  // To check the Pu-237 contibution to Pu-236 generation,
  // LWR pincell burnup calculation is carried out using the special chain
  // to which Pu-236 is added.
  // However, its contribution is negligible. (2022/8/7).

  SetLibrary(cbglibdir,lib);

  int nn=7;
  //string filename[]={"Th232T","Pa231","Pa233","U232","U233T","Np236","Pu236"};
  string filename[]={"Th232","Pa231","Pa233","U232","U233","Np236","Pu236"};  
...
void GeneralBurner::SetLibraryForThorium_361g(string cbglibdir,string lib)
{
  SetLibrary_361g(cbglibdir,lib);
  ...
  if(lib=="jendl-4.0"){
    ...
    cout<<"# Error in GeneralBurner::SetLibraryForThorium_361g.\n";
    cout<<"# Library "<<lib<<" does not exist.\n";
    exit(0);
  };
...
void GeneralBurner::ShowBurnupConditionSetting()
{
  ...
  if(burn_time_calc){
    ...
    cout<<"# Step  Day        Day-width   BU-width   ";
    if(input_flux_level){
      cout<<"Flux level";
    }else{
      cout<<"Power density";
    ...
    cout<<"#                              [GWD/t]";
    if(!input_flux_level){
      cout<<"    ["<<input_power_unit<<"]";
    };
    cout<<"\n#\n";

    real accumulate_time=0.;
    real accumulate_gwdt=0.;    
    real accumulate_power=0.;
    for(int i=0;i<burn_step;i++){
      cout<<"#";
      WriteOut(i,4);
      cout<<"   ";
      ...
      cout.precision(3);
      cout<<accumulate_time<<"  "<<burn_time[i]<<"   "<<burn_time_gwd[i]<<"  ";
      if(input_flux_level){
        cout<<flux_level_list[i];
        accumulate_power+=burn_time[i]*flux_level_list[i];      
      }else{
        cout<<power_density_list[i];
        accumulate_power+=burn_time[i]*power_density_list[i];            
      };
      cout<<"\n";
      accumulate_time+=burn_time[i];
      accumulate_gwdt+=burn_time_gwd[i];      
    };
    cout<<"#       "<<accumulate_time;
    cout<<"              "<<accumulate_gwdt<<"\n";
    cout<<"#\n";
    cout<<"# Accumulated power/flux : "<<accumulate_power<<"\n#\n";
    cout<<"# --------------------------------------------------\n";
...
#if 1
void GeneralBurner::SetLibraryTest(string cbglibdir,string lib)
{
  int fp_num=185+1;
  string filename_fp[]={
    // (Fission products : 185+1 nuclides)
  ...
  if(lib=="jendl-4"){
    libdir=libdir+"CBGLIB/j4.107g.iwt4/";
    //libdir=libdir+"CBGLIB/j4.107g.iwt3.j5t/";    
  }else if(lib=="jendl-5"){
    //libdir=libdir+"CBGLIB/j5a4.107g.iwt3.j5t/";
    libdir=libdir+"CBGLIB/j5b3.107g.iwt4/";    
  }else{
    cout<<"# Error in GeneralBurner::SetLibrary.\n";
    cout<<"# Library "<<lib<<" does not exist.\n";
    exit(0);
