...
void Burner::Cal1groupBranchingRatio(Burnup &bu, string cbglibdir,string filename,string outname)
{
  ...
  while(mat!=-1){
    fin>>mat;
    if(mat<10000&&mat>0){
      cout<<"# Please change the ENDF-ID to the CBZ-ID in BR data file.\n";
      exit(0);
    };
    if(mat==-1){
      fout<<"-1";
...
void Burner::SetDefaultCollapsingInfo()
{
  // ... from XMAS172 to casmo 9-grp
  /*
  ngrp=9;
  int bgrp2[]={21,46,91,115,125,134,151,159,171};
  */
  
  // ... from XMAS172 to casmo 18-grp
  //ngrp=9;
  //int bgrp2[]={4,13,21,24,32, 46,63,80,83,91, 103,115,125,134,145, 151,159,171};
  
  // ... from XMAS172 to casmo 25-grp
  /*
  ngrp=25;
  int bgrp2[]={4,7,10,13,16, 21,24,32,46,63, 80,83,91,103,115, 118,122,125,134,141, 145,151,159,163,171};
  */

#if 1  
  // ... from XMAS172 to 172 (no collapsing)
  ngrp=172;
...
// The following part is taken from the source files developed by Okuyama-san in 2022/10/7
...
// The following part is taken from the source files developed by Okuyama-san in 2022/10/5
#if 0
void Burner::EstimateTRUcompositionByROM(Burnup &bu, real burnup, real coolyear, bool pwr, string filename)
{
  real avo=0.60221367;
