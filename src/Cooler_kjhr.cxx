...
void Cooler::SensitivityCalculation(int mat,int step_num,real *time_step,real *power)
{
...
void Cooler::ShowDecayHeat(real tcor)
{
  cout<<"#\n";
...
{
  cout<<"#\n";
  cout<<"# time[s]   time[d]     time[y]     DecayHeat[J] [Actinide]  [F.P.]\n";
  cout.setf(ios::scientific);
  cout.precision(4);
  for(int i=0;i<total_step;i++){
    real en=0.;
