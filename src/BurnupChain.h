...
class BurnupChain{
 ...
 public:
  ...
  void FactorizeDecayConstant(real factor);
  ...
  void AddPseudoFPSeriesData(int fpnum, int *matid_fp, real *dc);
  void AddYieldDataToPseudoFP(int fissile_id, int fpnum, int *matid_fp, real *yield_fp);
  void AddYieldDataToPseudoFP1(int *fissile_id, int fissilenum, int fpnum, int *matid_fp, real *yield_fp);
  void AddPseudoFPSeriesData1(int fpnum, int fissilenum, int *matid_fp, real *dc);
